...
import { CountryTableSchema } from "../../schema/tool-inputs";
import { handleToolError } from "../../lib/utils/handleToolError";
import { getProjectBaseUrl } from "../../lib/utils/api";

type Params = z.infer<typeof CountryTableSchema>;
...
async function getCountryTableData(context: Context, projectId: string, startDate: string, endDate: string, limit: number) {
...
export const getCountryTableHandler = async (context: Context, params: Params) => {
    try {
        ...
        return handleToolError(error, "Failed to get country table data");
    }
};

export default function getCountryTable() {
    return {
        ...
        handler: getCountryTableHandler
    };
} 