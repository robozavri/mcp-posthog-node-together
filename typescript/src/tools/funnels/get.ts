...
import { FunnelGetSchema } from "@/schema/tool-inputs";

const schema = FunnelGetSchema;

type Params = z.infer<typeof schema>;

export const getFunnelHandler = async (context: Context, params: Params) => {
