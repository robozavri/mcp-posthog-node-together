...
import { ActiveUsersSchema } from "@/schema/tool-inputs";
...
const schema = ActiveUsersSchema;

type Params = z.infer<typeof schema>;

export const getActiveUsersHandler = async (context: Context, params: Params) => {
	...
	// Create a summary
	const totalActiveUsers = formattedResults.reduce((sum: number, item: { active_users: number }) => item.active_users + sum, 0);
