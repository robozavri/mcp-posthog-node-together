...
exports.getTimezoneTableHandler = void 0;
exports.default = getTimezoneTable;
...
async function getTimezoneTableData(context, projectId, startDate, endDate, limit) {
...
const getTimezoneTableHandler = async (context, params) => {
    try {
        ...
        return (0, handleToolError_1.handleToolError)(error, "Failed to get timezone table data");
    }
};
exports.getTimezoneTableHandler = getTimezoneTableHandler;
function getTimezoneTable() {
    return {
        ...
        schema: tool_inputs_1.TimezoneTableSchema,
        handler: exports.getTimezoneTableHandler
    };
}
