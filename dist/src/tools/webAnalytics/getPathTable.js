...
exports.getPathTableHandler = void 0;
exports.default = getPathTable;
...
async function getPathTableData(context, projectId, startDate, endDate, limit) {
...
const getPathTableHandler = async (context, params) => {
    try {
        ...
        return (0, handleToolError_1.handleToolError)(error, "Failed to get path table data");
    }
};
exports.getPathTableHandler = getPathTableHandler;
function getPathTable() {
    return {
        name: "get-path-table",
        description: "Get page path statistics with visitors, views, and bounce rate in a table format",
        schema: tool_inputs_1.PathTableSchema,
        handler: exports.getPathTableHandler
    };
}
