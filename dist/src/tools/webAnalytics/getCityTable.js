...
exports.getCityTableHandler = void 0;
exports.default = getCityTable;
...
async function getCityTableData(context, projectId, startDate, endDate, limit) {
...
const getCityTableHandler = async (context, params) => {
    try {
        ...
        return (0, handleToolError_1.handleToolError)(error, "Failed to get city table data");
    }
};
exports.getCityTableHandler = getCityTableHandler;
function getCityTable() {
    return {
        name: "get-city-table",
        description: "Get city statistics with visitors and views in a table format with comparison data",
        schema: tool_inputs_1.CityTableSchema,
        handler: exports.getCityTableHandler
    };
}
